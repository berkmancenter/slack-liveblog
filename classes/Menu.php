...
class Menu {
  ...
  public function slack_liveblog_add_admin_menu() {
    add_menu_page('Slack Liveblog', 'Slack Liveblog', 'manage_options', 'slack_liveblog_channels', [AdminCore::$actions, 'slack_liveblog_admin_init'], plugins_url('slack-liveblog/resources/img/slack_logo.svg'));
